...
// ParseProgram parses all tokens into an AST program
...
func (p *Parser) parseLetStatement() *ast.LetStatement {
	...
	// TODO: parse expression until semicolon
...
func (p *Parser) parseIntegerLiteral() ast.Expression {
	...
	if err != nil {
		p.parseIntegerLiteralError(p.curToken.Literal)
		return nil
	}
...
func (p *Parser) parseIntegerLiteralError(l string) {
